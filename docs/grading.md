...
* **Basic Hardware implementation [8 points]**
	...
	* **8 points**: The CPU functions and is able to run the demo program provided. 
	* **4 points**: The CPU does not function in hardware, but the simulation produces the correct result. 
	* **2 points**: The CPU does not function in hardware, and the simulation produces some correct results (but not all). 
